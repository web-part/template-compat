...
*
* source md5: 5466C8C1BF0FC069E2063A05BE410855
*
* source file: htdocs/views/company/register/Company/CompanyRegister/List.js
*/
...
KISP.panel('/CompanyRegister/List', function (require, module, panel) {
    ...
    { text: '法人企业（企业法人，企业非法人可选择）', value: 0 }, { text: '个体工商户（有个体工商户营业执照的个体工商户）', value: 1 }, { text: '个人（尚未取得任何证照的客户选择）', value: 2 }, { text: '其它组织（行政事业单位，非盈利组织、学习或外国机构选择）', value: 3 }];
