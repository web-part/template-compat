...
*
* source md5: 76C72D0F4CB3E4F332A17B39FDA6E0FB
*
* source file: htdocs/views/master/account/list/Accounts/Main/API.js
*/
...
define('/Accounts/Main/API', function (require, module, exports) {
    ...
    return {
        ...
        * 检测能否恢复账套。
        */
        checkRecover: function checkRecover(opt) {
        ...
        * 校验账套用户在线状态。
        */
        checkUser: function checkUser(opt) {
        ...
        * 设置自动备份。
        */
        setAutoBak: function setAutoBak(opt) {
        ...
        * 发起手动备份。
        */
        manualBak: function manualBak(opt) {
        ...
        * 恢复中刷新状态添加管理员账号。
        */
        refresh: function refresh(opt, accountId) {
            ...
            api.on({
                ...
                'success': function success(data, msg, json) {
