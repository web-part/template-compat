...
*
* source md5: EC54D7493963DB6E559E5B42EF093D45
*
* source file: htdocs/views/master/subject/Subject/Main/Tabs.js
*/
...
KISP.panel('/Subject/Main/Tabs', function (require, module, panel) {
    ...
    var list = [{ text: '按账套展示', cmd: 'accounts' }, { text: '按公司展示', cmd: 'companys' }];
