...
*
* source md5: 93E8167FAA693837AA8BAE300A5A922B
*
* source file: htdocs/views/master/company/auth/Auth/Main/auth/Auth/Type.js
*/
...
KISP.panel('/Auth/Main/Auth/Type', function (require, module, panel) {
    ...
    //id 是后台用到的，前端不用。
    var list = [{ id: '1', name: '法人企业', value: '0' }, { id: '2', name: '个体工商户', value: '0' }, { id: '4', name: '个人', value: '2' }, { id: '3', name: '其它组织', value: '3' }];
