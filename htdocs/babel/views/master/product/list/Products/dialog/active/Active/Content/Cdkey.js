...
*
* source md5: 391EA7F899A88B3540C8C5435C59B243
*
* source file: htdocs/views/master/product/list/Products/dialog/active/Active/Content/Cdkey.js
*/
...
KISP.panel('/Products/Active/Content/Cdkey', function (require, module, panel) {
    ...
    panel.on('init', function () {
        ...
        panel.$on('paste', {
            '[name="cdkey"]': function nameCdkey(e) {
