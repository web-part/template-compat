...
*
* source md5: 9094DD33CC5FEEC125C8809B0FB1DA0E
*
* source file: htdocs/views/master/application/user/ApplicationUsers/dialog/selector/Selector/Content/Add/Phone.js
*/
...
KISP.panel('/ApplicationUsers/Selector/Content/Add/Phone', function (require, module, panel) {
    ...
    return {
        ...
        *   };
        */
        checkExist: function checkExist(opt) {
            var txt = panel.$.get(0);
            var phone = txt.value;
            ...
            function show(type) {
                var msg = type + '用户列表中已存在该手机号:' + '<div style="color: red; margin: 10px 0px;">' + phone + '</div>';
