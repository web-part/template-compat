...
*
* source md5: D7C71F9C5AE8A1B883FFA5027950F8F9
*
* source file: htdocs/views/master/application/list/Application/Main/List.js
*/
...
KISP.panel('/Application/Main/List', function (require, module, panel) {
        ...
        panel.template({
            ...
            'table': {
                ...
                'row': {
                    ...
                    'drop': function drop(item, index, num) {
                        return {
                            'index': num,
                            'cmd': item.cmd,
                            'dropname': item.name
    ...
    panel.on('init', function () {
        ...
        panel.$.on('click', '[data-cmd]', function () {
            ...
            if (cmd === 'delete' && item.bind && item.tag === 'kisfxiaoke') {
                //分享逍客删除时的处理
