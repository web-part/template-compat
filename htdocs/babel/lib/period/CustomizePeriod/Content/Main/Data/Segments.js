...
*
* source md5: B1C7E2D784C5F83C8DD2A0F88A75985A
*
* source file: htdocs/lib/period/CustomizePeriod/Content/Main/Data/Segments.js
*/
...
define('CustomizePeriod/Content/Main/Data/Segments', function (require, module, exports) {
    ...
    return {
        ...
        * 根据指定的年份、期间数，创建期间列表。
        */
        create: function create(year, segment, parent) {
            var begin = 1;
            var end = segment + 1;
        ...
        */
        update: function update(item, value, related) {
