...
*
* source md5: 68D6E720D4385BEE9A2D7098899B4C1C
*
* source file: htdocs/lib/table/Table/Row.js
*/
...
define('Table/Row', function (require, module, exports) {
    ...
    return exports = {
        ...
        */
        create: function create(meta, detail) {
            var rows = meta.rows;
        ...
        * 删除一个指定行号的表格行。
        */
        remove: function remove(meta, no) {
            var rows = meta.rows;
            var row = rows[no];
        ...
        * 把指定行号的表格行向前或向后移动若干步。
        */
        move: function move(meta, index, step) {
            var rows = meta.rows;
