...
*
* source md5: 8742AFB30A1660763CD7D1794BC89304
*
* source file: htdocs/lib/Redirect.js
*/
...
define('Redirect', function (require, module, exports) {
    ...
    function getAll() {
        ...
        //安全起见，总是返回一个可用的 {}。
        return (typeof all === 'undefined' ? 'undefined' : _typeof(all)) == 'object' ? all || {} : {};
    }
