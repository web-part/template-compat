...
*
* source md5: 16A7D96265EE411A3D04F4EE1421458B
*
* source file: htdocs/lib/droplist/DropList.js
*/
...
define('DropList', function (require, module) {
            ...
            DropList.prototype = { //实例方法
                         ...
                         */
                        fill: function fill(list, keyword, fn) {
                                    //重载 fill(list, fn);
                                    ...
                                    list = $Array.map(list, function (item, index) {
                                                ...
                                                return value === false ? null : (typeof value === 'undefined' ? 'undefined' : _typeof(value)) == 'object' ? value : item;
                                    });
                        ...
                        set: function set(key, value) {
                                    var obj = $Object.isPlain(key) ? key : _defineProperty({}, key, value);
                                    var meta = mapper.get(this);
