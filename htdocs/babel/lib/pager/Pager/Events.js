...
*
* source md5: 81275848396D9B2211735FA7C07B8FCE
*
* source file: htdocs/lib/pager/Pager/Events.js
*/
    ...
    return {
        ...
        bind: function bind(meta) {
            ...
            meta.$.on('keydown', '#' + txtId, function (event) {
                ...
                var isNumber = 48 <= keyCode && keyCode <= 48 + 9 || //主键盘的 0 - 9
                96 <= keyCode && keyCode <= 96 + 9; //数字键盘的 0 - 9

                var isControl = keyCode == 8 || //回格键。
                keyCode == 37 || //向左箭头。
                keyCode == 39 || //向右箭头。
                keyCode == 46; //Delete 键
