...
*
* source md5: 99DBAFC471378909813379A007408C26
*
* source file: htdocs/modules/account/create/AccountCreate/type3/Type3/Content/Money.js
*/
...
* 本位币。
*/
KISP.panel('/AccountCreate/Type3/Content/Money', function (require, module, panel) {
    ...
    */
    ...
    return {
        get: function get() {
            ...
            if (precision < 0 || precision > 9 || precision === '') {
                toast.show('金额小数位必须在 0-9 之间', function () {
