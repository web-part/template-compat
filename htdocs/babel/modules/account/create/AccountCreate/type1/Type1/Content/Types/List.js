...
*
* source md5: E00AA0BC8D82BDC7CD02C451582C0BE6
*
* source file: htdocs/modules/account/create/AccountCreate/type1/Type1/Content/Types/List.js
*/
...
KISP.panel('/AccountCreate/Type1/Content/Types/List', function (require, module, panel) {
    ...
    //使用分仓核算 默认值 1。（总仓0，分仓1）
    {
        ...
        checked: true,
        title: '使用分仓核算',
        desc: ['选定则每个仓库独立核算成本，不选，则所有仓库的相同货品成本相同。', '<span class="warning">（建账后不可修改）<span>']
    },
    ...
    */
    panel.on('init', function () {
        ...
        panel.$on('click', {
            '[data-index]': function dataIndex(event) {
