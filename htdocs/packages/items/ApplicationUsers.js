...
KISP.panel('/ApplicationUsers/Selector/Content/Add/Name', function (require, module, panel) {
    var KISP = require('KISP');
...
KISP.panel('/ApplicationUsers/Selector/Content/List', function (require, module, panel) {
    ...
    */
    ...
    panel.on('render', function (items, para) {
        Info = [];
        var chosedData = items.applications;
...
* 
*/
KISP.panel('/ApplicationUsers/Selector/Content/Pager', function (require, module, panel) {
    var KISP = require('KISP');
