...
KISP.panel('/AccountCreate/Type2/Content/Subject/List', function (require, module, panel) {
    ...
    var list = [
        { name: '企业会计制度', value: '1', },
        { name: '小企业会计制度', value: '2', },
        { name: '2013小企业会计准则', value: '4', },
        { name: '新会计准则', value: '3', },
        { name: '新会计准则（含明细科目）', value: '5', },
        { name: '新会计准则科目（已执行新收入准则）', value: '12', },   //index = 5，这条特殊，仅测试环境需要用到。
        { name: '民间非营利组织', value: '11', },
        { name: '不预设科目体系', value: '0', },
    ];
